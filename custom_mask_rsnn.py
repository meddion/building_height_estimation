...
class CustomRoIHeads(RoIHeads):
    ...
    # TODO: impl
    def value_regression_loss(value_regression: Tensor, value_targets) -> Tensor:
        height_loss = nn.MSELoss()(value_regression, torch.cat(value_targets))
    ...
    def forward(
        ...
        if self.training:
            ...
            loss_value_regression = self.value_regression_loss(
                value_regression, targets["building_heights"]
            )
